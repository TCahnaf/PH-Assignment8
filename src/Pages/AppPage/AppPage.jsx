        ...
        <div className='mt-20 space-y-9 min-h-screen bg-[#E9E9E9]'>
            ...
            <div className = "flex justify-between items-center px-10">
                ...
                <div className = "relative ">
                    ...
                    <input className = "border border-gray-300 rounded-md pl-10 w-[400px] h-[48px]" type="text" placeholder='search Apps' name = "search-bar" onChange={handleSearch} />
                </div>
                </div>
            ...
            >
                ...
                {data.map(eachCard => <AppCards eachCard = {eachCard}></AppCards>)}
                ...
                <div className= {`${!isFiltered? 'hidden':''} grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-7 justify-items-center  `}>
                    {appsFiltered.map(eachCard => <AppCards eachCard={eachCard}></AppCards>)}
                </div>
