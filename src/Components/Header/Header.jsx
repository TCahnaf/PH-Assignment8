...
const Header = () => {
    ...
    <li className='hover:text-[#632EE3]'  ><NavLink>Home</NavLink></li>
    <li  className='hover:text-[#632EE3]' ><NavLink>Apps</NavLink></li>
    <li  className='hover:text-[#632EE3]' ><NavLink>Installation</NavLink></li>
    </ul>
