        ...
        <div className='space-y-4 max-w-[800px] mx-auto'>
            ...
            <div className = "flex gap-4 items-center justify-center">
                <button onClick = {playStoreNavigation}  className=' flex justify-center w-[200px] h-[56px] gap-2 items-center bg-white p-2'> 
                   <img className='w-8 h-8' src= "/images/google-play.png" alt="" />
                    Google Play</button>
                <button onClick = {appStoreNavigation}  className=' w-[200px] h-[56px] flex justify-center gap-2 items-center bg-white p-2'  > <img className='w-8 h-8' src= "/images/app-store.png" alt="" />
                    App Store</button>
            </div>
